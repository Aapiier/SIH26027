...
export const BASELINE_STATIONS: Station[] = [
...
export const BASELINE_SECTIONS: TrackSection[] = [
...
export const BASELINE_METRICS: DashboardMetrics = {
  ...
  horizon: 'WEEKLY',
  corridor: 'NDLS – PRYJ Trunk Corridor',
  model_version: 'HistGradientBoosting v3.0'
};

export const BASELINE_TASKS: MaintenanceRequest[] = [
  {
...
export const BASELINE_PLAN: BlockPlan = {
  plan_id: 'BP-2024-W38-OPTIMAL',
  horizon: 'WEEKLY',
  status: 'PUBLISHED',
...
export const BASELINE_AUDIT_LOGS: AuditLog[] = [
  {
    log_id: 'AUD-001',
    plan_id: 'BP-2024-W38-OPTIMAL',
...
export const BASELINE_BENCHMARK: BenchmarkResponse = {
  status: 'OPTIMAL',
...
export const BASELINE_VALIDATION: ValidationVerdict = {
  status: 'SUCCESS',
  validation_verdict: {
    plan_id: 'BP-2024-W38-OPTIMAL',
...
export const BASELINE_PRESETS: ScenarioPreset[] = [
  {
...
export function getBaselineTaskExplanation(requestId: string): TaskExplanation {
  const task = BASELINE_TASKS.find((t) => t.request_id === requestId) || BASELINE_TASKS[0];
...
export function getBaselineOpportunity(itemId: string): OpportunityEvaluation {
  return {
    item_id: itemId,
    score: 92.5,
...
export function getBaselineWhatIf(): WhatIfResponse {
  return {
    status: 'SIMULATED',
